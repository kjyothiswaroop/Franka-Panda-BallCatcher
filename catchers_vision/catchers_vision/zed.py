...
class ZedImage():
    ...
    def __init__(self, onnx_path, threshold=70):
        ...
        if os.path.exists(onnx_path):
            ...
            if status == sl.ERROR_CODE.SUCCESS:
                ...
                obj_runtime_param.detection_confidence_threshold = threshold
                self.zed.set_object_detection_runtime_parameters(obj_runtime_param)
    ...
    def get_frame(self):
        ...
        self.zed.retrieve_objects(self.objects, sl.ObjectDetectionRuntimeParameters())
        ...
        if best_obj is not None:
            ...
            cls_txt = f'({best_obj.confidence:.2f})'
